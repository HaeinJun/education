  ...
  return (
    <div className="rounded-xl p-5 border" style={{ background: "var(--card-bg)", borderColor: "var(--border)" }}>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <AreaChart data={quarterlyTrend} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
          <defs>
            <linearGradient id="hevGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#00AAD2" stopOpacity={0.3} />
              <stop offset="95%" stopColor="#00AAD2" stopOpacity={0} />
            </linearGradient>
          ...
          <Area type="monotone" dataKey="hev" name="HEV" stroke="#00AAD2" fill="url(#hevGrad)" strokeWidth={2} />
          <Area type="monotone" dataKey="ev" name="EV" stroke="#f0a500" fill="url(#evGrad)" strokeWidth={2} />
          <Area type="monotone" dataKey="phev" name="PHEV" stroke="#6bcb77" fill="none" strokeWidth={1.5} strokeDasharray="4 2" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
